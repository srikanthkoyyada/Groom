...
@Action(value = "start-sample-test-category", results = { @Result(name = "success", location = "/jsp/tests/sample-test.jsp") })
public class StartSampleTestCategoryAction extends ActionSupport {
	...
	public String execute() throws Exception {
		...
		setTopicList(quizService.getSampleTestTopics(user.getUserId(), getCategory(), 
				getTestCategory(), getStandard()));
